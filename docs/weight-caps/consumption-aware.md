...
capped_weights: weights/proposed-capped-consumption-aware.json
largest_clean_ratio: 0.000
...
| minute | 0.01 | 0.01038 | 0.01 |
| missed_optional | 0.25 | 0.35 | 0.25 |

# Utility Weight Adoption Checklist

weights: weights/proposed-capped-consumption-aware.json
baseline: benchmark-results/seed-baseline.json
status: adopted
